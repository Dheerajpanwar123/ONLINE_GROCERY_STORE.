...
#--  page 1------
    def main(sf):
        ...
        sf.lab=Button(sf.mainf2,text= "Click Here to enter the World of Grocery",command=lambda:sf.Login(),cursor="hand2", bd=10 ,font=("cooper black",30, 'bold'),fg="white",bg="#0b1335")
        sf.lab.place(x=250,y=250)
        sf.mainf2.pack(fill=BOTH,expand=1)
        sf.scr.mainloop()
#Fornt page design and button over it
...
#------ page 2------
    def Login(sf):
        ...
        sf.scr.destroy()
        sf.scr=Tk()
        sf.scr.title("Dheeraj Grocery Shop")
        sf.scr.geometry("1366x768")
        ...
        sf.home.place(x=800,y=100)#Main page link
        ...
        sf.lab1=Label(sf.loginf2,text="UserName",bg="#d3ede6",font=("cooper black",22))  #logn-inform Create
...
#it include second page frame upper part.        
        ...
        sf.rg=Button(sf.loginf2,text="New to Dheeraj Grocery Shop",command=lambda:sf.Register(),fg="white",cursor="hand2",bg="#8c68c1",font=("cooper black",20),bd=6)
        sf.rg.place(x=200,y=390)
        sf.c.create_rectangle(850,120,1310,480,fill="#d3ede6",outline="white",width=3)
        sf.ext=PhotoImage(file="p4.png")
        sf.url=Label(sf.loginf2,image=sf.ext,cursor="hand2").place(x=850,y=125)
    ...
    def about(sf):
        sf.scr1=Tk()
        sf.L=Label(sf.scr1,text="NEW Dheeraj Grocery SHOP")
        sf.L.pack()
        sf.scr1.mainloop()
...
##            sf.randomRef = str(sf.x)
            ...
            sf.v1=sf.vp1.get()
            if sf.v1=="Medium":
                sf.p1=float(sf.Chilli_Powder.get())*450
            elif sf.v1=="Large":
                sf.p1=float(sf.Chilli_Powder.get())*650
            else:
                sf.p1=float(sf.Chilli_Powder.get())*250
            sf.v2=sf.vp2.get()
            if sf.v2=="Medium":
                sf.p2= float(sf.Turmeric_Powder.get())*400
            elif sf.v2=="Large":
                sf.p2= float(sf.Turmeric_Powder.get())*600
            else:
                sf.p2= float(sf.Turmeric_Powder.get())*250
            sf.v3=sf.vp3.get()
            if sf.v3=="Medium":
            ...
            sf.v4=sf.vp4.get()
            if sf.v4=="Medium":
                sf.p4= float(sf.Ginger.get())*195
            elif sf.v4=="Large":
                sf.p4= float(sf.Ginger.get())*385
            else:
                sf.p4= float(sf.Ginger.get())*99  #change here 
            sf.v5=sf.vp5.get()
            if sf.v5=="Medium":
                sf.p5= float(sf.Kideny_Bean.get())*450 #Pulses
            elif sf.v5=="Large":
                sf.p5= float(sf.Kideny_Bean.get())*650
            else:
                sf.p5= float(sf.Kideny_Bean.get())*250
            sf.v6=sf.vp6.get()
            if sf.v6=="Medium":
                sf.p6= float(sf.Channa_Dal.get())*400
            elif sf.v6=="Large":
                sf.p6= float(sf.Channa_Dal.get())*600
            else:
                sf.p6= float(sf.Channa_Dal.get())*225
            sf.v7=sf.vp7.get()
            if sf.v7=="Medium":
                sf.p7= float(sf.Green_Gram.get())*385
            elif sf.v7=="Large":
                sf.p7= float(sf.Green_Gram.get())*550
            else:
                sf.p7= float(sf.Green_Gram.get())*225
            sf.v8=sf.vp8.get()
            if sf.v8=="Medium":
                sf.p8= float(sf.Broad_Bean.get())*195
            elif sf.v8=="Large":
                sf.p8= float(sf.Broad_Bean.get())*385
            else:
                sf.p8= float(sf.Broad_Bean.get())*99 #
        ...
        def reset(sf):
            sf.Chilli_Powder.set("0")
            sf.Turmeric_Powder.set("0")
            sf.Pepper.set("0")
            sf.Ginger.set("0")
            sf.Kideny_Bean.set("0")
            sf.Channa_Dal.set("0")
            sf.Green_Gram.set("0")
            sf.Broad_Bean.set("0")#
        ...
        def price(sf):
            ...
            sf.lblinfo = Label(sf.roo, font=('aria', 15,'bold'), text="Spices", fg="black", anchor=W)
            ...
            sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="Chilli Powder", fg="steel blue", anchor=W)
            ...
            sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="Turmeric Powder", fg="steel blue", anchor=W)
            ...
            sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="sf.Ginger", fg="steel blue", anchor=W)
            ...
            sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="Pulses", fg="black", anchor=W)
            sf.lblinfo.grid(row=6, column=1)
            sf.lblinfo = Label(sf.roo, font=('aria', 15), text="(Medium/Large/Regular)", fg="black", anchor=W)
            sf.lblinfo.grid(row=6, column=2)
            sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="Kideny Bean", fg="steel blue", anchor=W)
            sf.lblinfo.grid(row=7, column=0)
            sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="₹450/₹650/₹250", fg="steel blue", anchor=W)
            sf.lblinfo.grid(row=7, column=2)
            sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="Channa Dal", fg="steel blue", anchor=W)
            sf.lblinfo.grid(row=8, column=0)
            sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="₹400/₹600/₹250", fg="steel blue", anchor=W)
            sf.lblinfo.grid(row=8, column=2)
            sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="Green Gram", fg="steel blue", anchor=W)
            sf.lblinfo.grid(row=9, column=0)
            sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="₹385/₹550/₹225", fg="steel blue", anchor=W)
            sf.lblinfo.grid(row=9, column=2)
            sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="Broad Bean", fg="steel blue", anchor=W)#
        ...
        sf.Chilli_Powder= StringVar()
        sf.Turmeric_Powder = StringVar()
        sf.Pepper = StringVar()
        sf.Ginger= StringVar()
        sf.Kideny_Bean = StringVar()
        sf.Channa_Dal = StringVar()
        sf.Green_Gram= StringVar()
        sf.Broad_Bean= StringVar()#
        ...
        sf.lbl1 = Label(sf.admainf2,pady=2, font=( 'Cooper Black' ,20, 'bold','underline' ),bg="#f2e8b8",text="Spices",bd=10,anchor='w')
        ...
        sf.lbl2 = Label(sf.admainf2,pady=2, font=( 'Cooper Black' ,20, 'bold','underline' ),bg="#f2e8b8",text="Pulses",bd=10,anchor='w')
...
#--  page 6------        *********************MENU***********************
    def menulist(sf,x):
        ...
        sf.veg=PhotoImage(file="spice.png")
        sf.c.create_image(430,250,image=sf.veg)
        sf.vegbut=Button(sf.menuf2,text="Spices",cursor="hand2",fg="white",command=lambda:sf.vegpizza(sf.x),bg="#0b1335",bd=5,font=("default",18,'bold'))
        sf.vegbut.place(x=370,y=350)
        
        sf.nonveg=PhotoImage(file="puls.png")
        sf.c.create_image(840,250,image=sf.nonveg)
        sf.nonvegbut=Button(sf.menuf2,text="Pulses",cursor="hand2",fg="white",command=lambda:sf.nonvegpiz(sf.x),bg="#0b1335",bd=5,font=("default",18,'bold'))
...
#--  page 7------ ************Main Page after login **************
    def pizmain(sf):
        sf.scr.destroy()
        sf.scr=Tk()
        sf.scr.title("Grocery Center")
        sf.scr.geometry("1366x768")
        #sf.scr.resizable(False, False)
...
#--  page 8------
    def vegpizza(sf,x):
        ...
        sf.logo1=PhotoImage(file="bg.png")
        sf.c.create_image(683,309,image=sf.logo1)
        sf.log=Label(sf.vegf2,text="SPICES",bg="#9db1f2",font=("Cooper Black",22))
        ...
        sf.delu=PhotoImage(file="turm.png")
        sf.c.create_image(470,110,image=sf.delu)
        sf.c.create_text(650,80,text="Turmeric",fill="#000000",font=("Cooper Black",20))
        ...
        sf.C12 = Radiobutton(sf.vegf2, text = "500 G",value = 20, variable =sf.v1)
        sf.C12.place(x=650,y=100)
        sf.C13 = Radiobutton(sf.vegf2, text = "250 G",value = 30, variable =sf.v1)
        ...
        def addch1():
            if sf.v1.get()==10:
                ...
                ch1="250 G"
                pric1=250
            sf.addlist(["Spices",ch1,sf.q1.get(),pric1*int(sf.q1.get())])
            
        #pizza 2
        sf.c.create_rectangle(405, 170, 960, 290,width=2)
        sf.vag=PhotoImage(file="red1.png")
        sf.c.create_image(470,230,image=sf.vag)
        sf.c.create_text(650,200,text="Red Chilli Powder",fill="#000000",font=("Cooper Black",20))
...
##        ch2=sf.check(sf.vegf2,220)
        ...
        sf.C22 = Radiobutton(sf.vegf2, text = "500 G",value = 20, variable =sf.v2)
        sf.C22.place(x=650,y=220)
        sf.C23 = Radiobutton(sf.vegf2, text = "250 G",value = 30, variable =sf.v2)
        ...
        def addch2():
            ...
            sf.addlist(["Red Chilli Powder",ch2,sf.q2.get(),pric2*int(sf.q2.get())])
        #pizza 3
        sf.c.create_rectangle(405, 290, 960, 410,width=2)
        sf.pep=PhotoImage(file="gin.png")
        sf.c.create_image(470,350,image=sf.pep)
        sf.c.create_text(650,320,text="Ginger Powder",fill="#000000",font=("Cooper Black",20))
        sf.c.create_text(860,320,text="₹385/₹550/₹225",fill="#ff3838",font=("default",17,'bold'))
        #ch3=sf.check(sf.vegf2,340)
        sf.v3=IntVar()
        sf.C31=Radiobutton(sf.vegf2,text = "500 G",value=10,variable=sf.v3)
        sf.C31.place(x=550,y=340)
        sf.C32 = Radiobutton(sf.vegf2, text = "300 G",value = 20, variable =sf.v3)
        sf.C32.place(x=650,y=340)
        sf.C33 = Radiobutton(sf.vegf2, text = "100 G",value = 30, variable =sf.v3)
        ...
        def addch3():
            if sf.v3.get()==10:
                ...
                ch3="100 G"
                pric3=225
            sf.addlist(["Ginger Powder     ",ch3,sf.q3.get(),pric3*int(sf.q3.get())])
            
        #pizza 4
        sf.c.create_rectangle(405, 410, 960, 530,width=2)
        sf.mag=PhotoImage(file="safron.png")
        sf.c.create_image(470,470,image=sf.mag)
        sf.c.create_text(650,440,text="Safron",fill="#000000",font=("Cooper Black",20))
        sf.c.create_text(860,440,text="₹195/₹385/₹99",fill="#ff3838",font=("default",17,'bold'))
        #ch4=sf.check(sf.vegf2,460)
        sf.v4=IntVar()
        sf.C41=Radiobutton(sf.vegf2,text = "500 G",value=10,variable=sf.v4)
        sf.C41.place(x=550,y=460)
        sf.C42 = Radiobutton(sf.vegf2, text = "300 G",value = 20, variable =sf.v4)
        sf.C42.place(x=650,y=460)
        sf.C43 = Radiobutton(sf.vegf2, text = "100 G",value = 30, variable =sf.v4)
        ...
        def addch4():
            if sf.v4.get()==10:
                ...
                ch4="100 G"
                pric4=99
            sf.addlist(["Safron  ",ch4,sf.q4.get(),pric4*int(sf.q4.get())])
...
#--  page 10------
    def nonvegpiz(sf,x):
        ...
        sf.logo1=PhotoImage(file="bg.png")
        sf.c.create_image(683,309,image=sf.logo1)
        sf.log=Label(sf.nonvegf2,text="PULSES",bg="#9db1f2",font=("Cooper Black",22))
        ...
        # pizza 1
        sf.c.create_rectangle(405, 50, 960, 170,width=2)
        sf.delu=PhotoImage(file="soya.png")
        sf.c.create_image(470,110,image=sf.delu)
        sf.c.create_text(650,80,text="Soyabean",fill="#000000",font=("Cooper Black",20))
        sf.c.create_text(860,80,text="₹450/₹650/₹250",fill="#ff3838",font=("default",17,'bold'))
        #ch5=sf.check(sf.nonvegf2,100)
        sf.v5=IntVar()
        sf.C51=Radiobutton(sf.nonvegf2,text = "1 KG",value=10,variable=sf.v5)
        sf.C51.place(x=550,y=100)
        sf.C52 = Radiobutton(sf.nonvegf2, text = "2 KG",value = 20, variable =sf.v5)
        sf.C52.place(x=650,y=100)
        sf.C53 = Radiobutton(sf.nonvegf2, text = "3 KG",value = 30, variable =sf.v5)
        ...
        def addch5():
            if sf.v5.get()==10:
                ...
                ch5="3 KG"
                pric5=250
            sf.addlist(["Soyabean",ch5,sf.q5.get(),pric5*int(sf.q5.get())])
        #pizza 2
        sf.c.create_rectangle(405, 170, 960, 290,width=2)
        sf.vag=PhotoImage(file="redbin.png")
        sf.c.create_image(470,230,image=sf.vag)
        sf.c.create_text(650,200,text="Red Kidney Beans",fill="#000000",font=("Cooper Black",20))
        sf.c.create_text(860,200,text="₹400/₹600/₹250",fill="#ff3838",font=("default",17,'bold'))
        #ch6=sf.check(sf.nonvegf2,220)
        sf.v6=IntVar()
        sf.C61=Radiobutton(sf.nonvegf2,text = "1 KG",value=10,variable=sf.v6)
        sf.C61.place(x=550,y=220)
        sf.C62 = Radiobutton(sf.nonvegf2, text = "2 KG",value = 20, variable =sf.v6)
        sf.C62.place(x=650,y=220)
        sf.C63 = Radiobutton(sf.nonvegf2, text = "3 Kg",value = 30, variable =sf.v6)
        ...
        def addch6():
            if sf.v6.get()==10:
                ...
                ch6="3 KG"
                pric6=250
            sf.addlist(["Red kidney Bean",ch6,sf.q6.get(),pric6*int(sf.q6.get())])
        #pizza 3
        sf.c.create_rectangle(405, 290, 960, 410,width=2)
        sf.pep=PhotoImage(file="black.png")
        sf.c.create_image(470,350,image=sf.pep)
        sf.c.create_text(650,320,text="BlackGram",fill="#000000",font=("Cooper Black",20))
        sf.c.create_text(860,320,text="₹385/₹550/₹225",fill="#ff3838",font=("default",17,'bold'))
        #ch7=sf.check(sf.nonvegf2,340)
        sf.v7=IntVar()
        sf.C71=Radiobutton(sf.nonvegf2,text = "1 KG",value=10,variable=sf.v7)
        sf.C71.place(x=550,y=340)
        sf.C72 = Radiobutton(sf.nonvegf2, text = "2 KG",value = 20, variable =sf.v7)
        sf.C72.place(x=650,y=340)
        sf.C73 = Radiobutton(sf.nonvegf2, text = "3 KG",value = 30, variable =sf.v7)
        ...
        def addch7():
            if sf.v7.get()==10:
                ...
                ch7="3 KG"
                pric7=225
            sf.addlist(["BlackGram",ch7,sf.q7.get(),pric7*int(sf.q7.get())])
        #pizza 4
        sf.c.create_rectangle(405, 410, 960, 530,width=2)
        sf.mag=PhotoImage(file="green.png")
        sf.c.create_image(470,470,image=sf.mag)
        sf.c.create_text(650,440,text="Green Gram",fill="#000000",font=("Cooper Black",20))
        sf.c.create_text(860,440,text="₹195/₹385/₹99",fill="#ff3838",font=("default",17,'bold'))
        #ch8=sf.check(sf.nonvegf2,460)
        sf.v8=IntVar()
        sf.C81=Radiobutton(sf.nonvegf2,text = "1 KG",value=10,variable=sf.v8)
        sf.C81.place(x=550,y=460)
        sf.C82 = Radiobutton(sf.nonvegf2, text = "2 KG",value = 20, variable =sf.v8)
        sf.C82.place(x=650,y=460)
        sf.C83 = Radiobutton(sf.nonvegf2, text = "3 KG",value = 30, variable =sf.v8)
        ...
        def addch8():
            if sf.v8.get()==10:
                ...
                ch8="3 KG"
                pric8=99
            sf.addlist(["Green Gram",ch8,sf.q8.get(),pric8*int(sf.q8.get())])
